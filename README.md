...
|:---:|:---|:---:|
| 🖼️ **Vision Language Models (VLMs)** | 视觉语言模型：感知、理解与多模态推理<br>Perception, understanding, and multimodal reasoning | [📄 View](./Awesome-Vision-Language-Models.md) |
| 🤖 **Vision Language Action Models (VLAs)** | 视觉语言动作模型：从感知到物理决策<br>From perception to physical decision-making | [📄 View](./Awesome-Vision-Language-Action-Models.md) |
